...
if __name__ == "__main__":
    ...
    x_1000 = data_matrix[:, 1:1001]
    data_matrix = np.column_stack((t, x_1000, y))
    ...
    for sample_size in sample_sizes:
        ...
        for _ in range(num_iterations):
            ...
            models = ['weightednet', 'weightednet_TR']
            for model_name in models:
                if model_name == 'Vcnet' or model_name == 'Vcnet_TR':
                    cfg_density = [(1000, 50, 1, 'relu'),
                                   (50, 50, 1, 'relu')]
                    num_grid = 10
                    ...
                    weights_info = independence_weights(
                        train_matrix[:, 0].numpy(), train_matrix[:, 1:-3001].numpy())

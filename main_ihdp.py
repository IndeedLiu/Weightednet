...
if __name__ == "__main__":
    ...
    for sample_size in sample_sizes:
        ...
        for _ in range(num_iterations):
            ...
            test_idx = idx[sample_size:sample_size + 247]
            ...
            for model_name in models:
                ...
                isTargetReg = model_name == 'Vcnet_TR'
        ...
        mse_vcnet.append(np.mean(mse_vcnet_iter))
        mse_vcnet_tr.append(np.mean(mse_vcnet_tr_iter))
        mse_weightednet.append(np.mean(mse_weightednet_iter))

    # 打印 VCNet 测试集的 MSE
    print("VCNet Test MSE:", mse_vcnet)

    # 打印 VCNet 训练集的 MSE
    print("VCNet_tr Train MSE:", mse_vcnet_tr)
